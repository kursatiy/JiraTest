...
public class ChangePasswordPopUp {
    ...
    public  void enterCurrentPass(String currentPass){$(By.xpath(currentPassInPopUpId)).sendKeys(currentPass);   }
    public  void enterNewPass(String newPass){$(By.xpath(newPassInPopUpId)).sendKeys(newPass);   }
    public  void enterNewPassForConfirm(String passForConfirm){$(By.xpath(confirmPassInPopUpId)).sendKeys(passForConfirm);   }
    public void clickOnupdateButton(){$(By.xpath(updateButtonId)).sendKeys(Keys.ENTER);}
    public boolean popUp(){return  $(By.xpath(settingsUpdatedNotifyPopUpId)).isDisplayed();}
