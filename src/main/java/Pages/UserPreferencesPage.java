...
public class UserPreferencesPage {
    ...
    public void clickOnPrefEditButton(){$(By.xpath(userPreferencesEditButton)).click();}
    public void clickOnTimeZoneMenu() {$(By.xpath(timeZoneDropDownMenu)).click();}
    public void clickOnElementInDDM(){$(By.xpath(elementsAtTZDropDown)).click();}
    public void clickOnElementInLocalization(){$(By.xpath(elemntsAtLocationDropDown)).click();}
    public void clickOnUpdateButton(){$(By.xpath(updateButton)).click();}
